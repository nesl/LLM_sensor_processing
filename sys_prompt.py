...
You need to implement both functions inspection, inspection_freq, and solver:

 ```Python 
def inspection(input_data, sampling_rate=None):
    # If necessary, inspect the input_data in time doamin before implementing the solver
    # The results should be printed inside the function.
    # Args:
    #   input_data: The data type is numpy.ndarray. This is the data provided by the user to perform DSP. 
    #   sampling_rate: The sampling rate of the data. sampling_rate is mandatory for speech, ecg, ppg, and gait data. It could be optional for others.
...
After implementation of inspection, pause and wait for the results. 
 ...
 ```Python 
def inspection_freq(input_data, sampling_rate=None):
    # If necessary, inspect the input_data in frequency doamin before implementing the solver
    # The results should be printed inside the function.
    # Args:
    #   input_data: The data type is numpy.ndarray. This is the data provided by the user to perform DSP. 
    #   sampling_rate: The sampling rate of the data. sampling_rate is mandatory for speech, ecg, ppg, and gait data. It could be optional for others.
...
After implementation of inspection_freq, pause and wait for the results. 

Then based on the output from state if there are any unwanted interference. Then, after your understandig of the signal, start implement the solver:

 ```Python 
def solver(input_data, sampling_rate=None):
    # HERE is where you put your solution. Perform necessary data preprocessing
    # Args:
    #   cleaned_data: The data type is numpy.ndarray. This is the data generated by preprocessing.
    #   sampling_rate: The sampling rate of the data. sampling_rate is mandatory for speech, ecg, ppg, and gait data. It could be optional for others.
    # Output:
    #   return: return the processed data in numpy.ndarray
 ```
